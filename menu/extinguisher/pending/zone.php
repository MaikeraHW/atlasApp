...
$sql = "SELECT daymonth, extingnumber, extloc FROM testingdata WHERE daymonth LIKE ? AND extzone LIKE ?";
...
<html lang="pt-br">
  ...
  <body>
    <main class="main-menu">
      ...
      <h2 class="menu-subtitle">Extintores Pendentes - <?php echo $_GET['zone'] ?></h2>
      <div class="content">
        <table class="table">
          <tr>
            <th>Nº</th>
           ...
           <?php
              if ($resultado->num_rows > 0) { while ($linha = $resultado->fetch_assoc()) { 
                echo "<tr>"; 
                echo "<td>" . htmlspecialchars($linha["extingnumber"]) . "</td>"; 
                echo "<td>" . htmlspecialchars($linha["extloc"]) . "</td>"; 
                echo "</tr>"; } 
              } else { 
                echo "<tr>"; 
                echo "<td colspan='2'> Nenhum item pendente </td>"; 
                echo "</tr>"; 
                } ?>
        </table>
        <?php
