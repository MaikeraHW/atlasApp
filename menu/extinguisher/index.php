...
<html lang="pt-br">
  <head>
    ...
    <link rel="stylesheet" href="extinguisher-menu.css" />
    <link rel="stylesheet" href="../../colors.css" />

    <title>Fire Atlas - Extintores</title>
  </head>
  <body>
    <main class="main-menu">
      ...
      <section class="buttons-section">
        ...
        echo '<a class="buttons" href="register">Cadastrar</a>';
        echo '<a class="buttons" href="edit/edit.php">Alterar</a>';
