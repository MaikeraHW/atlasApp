...
$sql = "SELECT contentdata, extingnumber, extloc FROM testingdata WHERE contentdata LIKE ? AND extzone LIKE ?";
...
<html lang="pt-br">
  ...
  <body>
    <main class="main-menu">
      ...
      <h2 class="menu-subtitle">Extintores Vencendo - <?php echo $_GET['zone'] ?></h2>
      <div class="content">
        <table class="table">
          <tr>
            <th>Nº</th>
          ...
          <?php
              if ($resultado->num_rows > 0) { while ($linha = $resultado->fetch_assoc()) { echo "
          <tr>
            "; echo "
